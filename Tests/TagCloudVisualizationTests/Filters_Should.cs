...
namespace Tests.TagCloudVisualizationTests
{
    ...
    public class Filters_Should
    {
        ...
        public void SetUp()
        {
            ...
            fakePosTagger.Setup(m => m.Recognize(It.IsAny<string>())).Returns(Result.Ok(PartsOfSpeech.Adjective));
            fakePosTagger.Setup(m => m.Recognize(It.Is<string>(v => v == "can"))).Returns(Result.Ok(PartsOfSpeech.Verb));
            fakePosTagger.Setup(m => m.Recognize(It.Is<string>(v => v == "aa"))).Returns(Result.Ok(PartsOfSpeech.Unknown));
        ...
        public void ShortWordsFilterShuld_FulterWordShorter4_WhenWordsNotNull()
        {
            ...
            var goodWords = shortWordsFilter.Filter(words).Value;
        ...
        public void PartsOfSpeechFilterShould_FilterVerbs_WhenWordsIsNotNull()
        {
            ...
            var goodWords = partsOfSpeechFilter.Filter(words).Value;
            goodWords.Should().HaveCount(1);
        ...
        public void PartsOfSpeechFilterShould_FilterVerbs_WhenWordTextIsNull()
        {
            ...
            partsOfSpeechFilter.Filter(words).Value.Should().HaveCount(0);
        }
        ...
        public void BoringWordsFilterShould_FilterWordsFromBoringWordsList()
        {
            ...
            var goodWords = blackList.Filter(words).Value;
            goodWords.Should().HaveCount(1);
