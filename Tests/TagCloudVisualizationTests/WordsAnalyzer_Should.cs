    ...
    public class WordsAnalyzer_Should
    {
        ...
        public void ExcludeShortWords_WhenWordsNotInBlackList()
        {
            fakeFilter
                ...
                .Returns<IEnumerable<Word>>(w => Result.Ok(w.Where(wd => wd.Text.Length > 3)));
            var words = new List<string> { "aa", "aa", "a" };
            analyzer.Analyze(words, 150, fakeFiltersNames, fakeConvertesNames).Value.SortedWordsTop.Should().BeEmpty();
        }
        ...
        public void RetutnFirst2Words_WhenWordsCount2()
        {
            ...
            var actualTopWords = analyzer.Analyze(words, 2, fakeFiltersNames, fakeConvertesNames).Value.SortedWordsTop;
        ...
        public void ReturnWordsInDescendingOrder()
        {
            ...
            var actualSortedWords = analyzer.Analyze(words, 4, fakeFiltersNames, fakeConvertesNames).Value.SortedWordsTop;
